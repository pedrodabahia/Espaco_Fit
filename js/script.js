$(function(){
   ...
   function contadorSlider(){
    ...
    function formatedSlider(){
        ...
        $('section.sobre-empresa .text-sobre').css('padding', '5vh 0 0 0');
        ...
        $('section.serviços .title').css('margin-top','0').css('padding-top','40px').css('font-size','2.7vw').css(' height','40vw');
