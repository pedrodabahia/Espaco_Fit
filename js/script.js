$(function(){
   ...
   function contadorSlider(){
    ...
    function formatedSlider(){
        ...
        $('section.sobre-empresa .text-sobre p').css( 'font-size', '2vh').css( 'width','70%').css('margin',' 3.5vw auto').css('text-align','center').css('display','block').css('text-shadow',' 0 1vw 3vw rgb(000,141,207)');;
        ...
        $('section.sobre-empresa .text-sobre').css('padding', '5vh 0 0 0').css('height','auto').css('text-align','center').css('margin','2vw 5% 4vw 5%').css('text-shadow',' 0 1vw 3vw rgb(000,)');
