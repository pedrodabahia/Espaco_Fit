$(function(){
   ...
   function contadorSlider(){
    ...
    function formatedSlider(){
        ...
        $('section.sobre-empresa .text-sobre h1').css('font-size','10vw').css('text-shadow','0 1vw 3vw rgb(000,141,207)')
        ...
        $('section.sobre-empresa .text-sobre, section.sobre-empresa .banners-atletas').css('width','90%').css('height','45%').css('display','block;').css('overflow',' hidden').css('float','unset').css('display','inline-block').css('position','static').css('margin','9vw')..css('text-shadow',' 0 1vw 3vw rgb(000,141,207)');
        $('section.sobre-empresa .text-sobre').css('padding', '5vh 0 0 0').css('height','auto').css('text-align','center').css('margin','2vw 5% 0 5%').css('text-shadow',' 0 1vw 3vw rgb(000,141,207)');
        ...
        $('section.sobre-empresa ').css('align-items','center').css('text-align','center').css('text-shadow',' 0 1vw 3vw rgb(000,141, 207)');;
